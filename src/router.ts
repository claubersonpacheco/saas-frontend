...
import BudgetItemsCreatePage from './pages/budget-items/create.vue';
import BudgetItemsEditPage from './pages/budget-items/edit.vue';
import BudgetItemsIndexPage from './pages/budget-items/index.vue';
import BudgetStatusesCreatePage from './pages/budget-statuses/create.vue';
import BudgetStatusesEditPage from './pages/budget-statuses/edit.vue';
import BudgetStatusesIndexPage from './pages/budget-statuses/index.vue';
import BudgetTotalsCreatePage from './pages/budget-totals/create.vue';
import BudgetTotalsEditPage from './pages/budget-totals/edit.vue';
import BudgetTotalsIndexPage from './pages/budget-totals/index.vue';
import BudgetsCreatePage from './pages/budgets/create.vue';
import BudgetsEditPage from './pages/budgets/edit.vue';
import BudgetsIndexPage from './pages/budgets/index.vue';
import BudgetsItemsPage from './pages/budgets/items.vue';
import CategoriesCreatePage from './pages/categories/create.vue';
import CategoriesEditPage from './pages/categories/edit.vue';
import CategoriesIndexPage from './pages/categories/index.vue';
import CustomersCreatePage from './pages/customers/create.vue';
import CustomersEditPage from './pages/customers/edit.vue';
import CustomersIndexPage from './pages/customers/index.vue';
import EmailsCreatePage from './pages/emails/create.vue';
import EmailsEditPage from './pages/emails/edit.vue';
import EmailsIndexPage from './pages/emails/index.vue';
import EntriesCreatePage from './pages/entries/create.vue';
import EntriesEditPage from './pages/entries/edit.vue';
import EntriesIndexPage from './pages/entries/index.vue';
import ExpensesCreatePage from './pages/expenses/create.vue';
import ExpensesEditPage from './pages/expenses/edit.vue';
import ExpensesIndexPage from './pages/expenses/index.vue';
import FreelancersCreatePage from './pages/freelancers/create.vue';
import FreelancersEditPage from './pages/freelancers/edit.vue';
import FreelancersIndexPage from './pages/freelancers/index.vue';
import InvoicesCreatePage from './pages/invoices/create.vue';
import InvoicesEditPage from './pages/invoices/edit.vue';
import InvoicesIndexPage from './pages/invoices/index.vue';
import PermissionsCreatePage from './pages/permissions/create.vue';
import PermissionsEditPage from './pages/permissions/edit.vue';
import PermissionsIndexPage from './pages/permissions/index.vue';
import PlansCreatePage from './pages/plans/create.vue';
import PlansEditPage from './pages/plans/edit.vue';
import PlansIndexPage from './pages/plans/index.vue';
import ProfilePage from './pages/profile/index.vue';
import RolesCreatePage from './pages/roles/create.vue';
import RolesEditPage from './pages/roles/edit.vue';
import RolesIndexPage from './pages/roles/index.vue';
import SettingsCreatePage from './pages/settings/create.vue';
import SettingsEditPage from './pages/settings/edit.vue';
import SettingsIndexPage from './pages/settings/index.vue';
import ServicesCreatePage from './pages/services/create.vue';
import ServicesEditPage from './pages/services/edit.vue';
import ServicesIndexPage from './pages/services/index.vue';
import ProductsCreatePage from './pages/products/create.vue';
import ProductsEditPage from './pages/products/edit.vue';
import ProductsIndexPage from './pages/products/index.vue';
import SuppliersCreatePage from './pages/suppliers/create.vue';
import SuppliersEditPage from './pages/suppliers/edit.vue';
import SuppliersIndexPage from './pages/suppliers/index.vue';
import TenantsCreatePage from './pages/tenants/create.vue';
import TenantsEditPage from './pages/tenants/edit.vue';
import TenantsIndexPage from './pages/tenants/index.vue';
import UsersCreatePage from './pages/users/create.vue';
import UsersEditPage from './pages/users/edit.vue';
